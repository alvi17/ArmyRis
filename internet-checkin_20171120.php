...
$connectivity = Subscriber::calcInternectCheckinDuration($params['status_id'], $params['disconnect_date'], $params['package_days']);
$btnTxt = Subscriber::internetCheckinBtnText($params, $connectivity);

if(Input::exists()){
    if(Token::check(TOKEN_LEVEL, Input::post(TOKEN_LEVEL))){
        
        if($params['payment_balance'] < $params['package_price']){
            ...
            try{
                ...
                $router = $mikrotik_routers[ $params['router_no'] ];
