...
$pageCode       = 'report-bandwidth-2';
$pageContent	= 'report/bandwidth-2';
$pageTitle 		= 'Bandwidth Report (Method 2)';
...
WHERE a.`connection_from` <= '$dtt_date_to' AND a.`connection_to` >= '$dtt_date_from'
...
a.`connection_from` <= '$dtt_date_to' AND a.`connection_to` >= '$dtt_date_from'
*/